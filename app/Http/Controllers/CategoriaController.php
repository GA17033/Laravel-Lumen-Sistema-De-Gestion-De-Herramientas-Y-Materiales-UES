...
class CategoriaController extends Controller
{
    ...
    {
        $sql = DB::select("select categoria.id_categoria , categoria.nombre , tipo_producto.nombre as id_tipo from categoria inner join tipo_producto on categoria.id_tipo = tipo_producto.id_tipo where estado=1");
    ...
    {
        $sql = DB::select("select * from tipo_producto");
        return view("vistas/categoria/registrar", compact("sql"));
    }
    ...
    public function store(Request $request)
    {
        ...
        $sql = DB::insert(" insert into categoria(nombre,id_tipo,estado) values(?,?,1) ", [
            $request->nombre,
            $request->id_tipo
        ]);
        if ($sql == 1) {
    ...
    public function edit($id)
    {
        ...
        return view("vistas/categoria/actualizar", compact("sql"))->with("sql3", $sql2);
    }
