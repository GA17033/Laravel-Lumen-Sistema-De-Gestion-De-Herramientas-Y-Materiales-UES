...
Route::get("/categoria-elemento/{id}", [ProductoController::class, "agregarElemento"])->name("producto.buscar")->middleware("verified");
...
Route::get("/salidas/{id}", [SalidaController::class, "edit"])->name("salida.edit")->middleware("verified");
