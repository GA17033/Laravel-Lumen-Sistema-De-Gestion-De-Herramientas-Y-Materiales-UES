        ...
        <div class="row">
            ...
            <label for="foto">Fecha De Finalizacion</label>
                <input type="date" name="fecha_final" class="input input__text" id="fecha_final"
                    value="{{old('fecha_final',$item->fecha_final)}}">
            </div>
            <div class="fl-flex-label mb-4 col-12 col-lg-6">
                <input type="file" name="foto" class="input form-control-file input__text" value="{{old('foto',$item->foto)}}">
            </div>
            ...
            <div class="fl-flex-label mb-4 col-12 col-lg-6">
                ...
                value="{{old('nombreC',$item->nombreC)}}" >
                @error('nombre')
                <small class="error error__text">{{$message}}</small>
                @enderror
            </div>
