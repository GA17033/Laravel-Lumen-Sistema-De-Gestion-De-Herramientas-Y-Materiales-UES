...
@endif
@foreach ($sqlp as $item)
<h4 class="text-center text-secondary">Proyecto : {{$item->nombre}}</h4>
@endforeach
<div class="pb-1 pt-2">
    <a href="{{route('herramienta.create',$id_proyecto)}}" class="btn btn-rounded btn-success"><i class="fas fa-plus"></i>&nbsp;
        Registrar</a>
</div>
<!-- <h1>{{$id_proyecto}}</h1> -->
