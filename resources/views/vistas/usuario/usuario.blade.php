...
<div class="pb-1 pt-2">
    <a href="{{route('usuario.create')}}" class="btn btn-rounded" style="background-color:#5DB476"><i class="fas fa-plus"></i>&nbsp;
        Registrar</a>
</div>
                                    ...
                                    <div class="form-group mb-1 col-12">
                                        <form action="{{route('usuario.actualizarImagen')}}"
                                            ...
                                            <div class="pb-1 pt-2 text-right mt-2">
                                                ...
                                                <button type="submit"
                                                    class="btn btn-rounded btn-success" >Modificar</button>
                                                @else
                                                <button type="submit"
                                                    class="btn btn-rounded btn-success">Agregar</button>
                                                @endif
