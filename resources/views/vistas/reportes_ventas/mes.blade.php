@extends('layouts/app')
@section('titulo',"salidas por mes")
@section('content')
<h4 class="text-center text-secondary">SALIDAS POR MES</h4>
...
<script>
    ...
    function buscarVenta(){
        ...
        var ruta = "{{ url('reporte-mes-search/') }}/" + valor + "";
        $.ajax({
            url: ruta,
            type: "get",
            success: function(data) {
                let imprimir=document.getElementById("imprimir");
                imprimir.href=`reporte-pdf-mes/${data[0].fecha}`;
