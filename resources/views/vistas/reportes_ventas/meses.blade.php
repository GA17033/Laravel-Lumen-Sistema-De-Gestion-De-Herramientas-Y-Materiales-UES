@extends('layouts/app')
@section('titulo',"salidas de hoy")
@section('content')
<h4 class="text-center text-secondary">SALIDAS POR MESES</h4>

<div class="row container-fluid m-auto">
    <div class="col-12 col-md-6 mb-3">
        <label for="fecha1">Desde</label>
        <input type="month" id="fecha1" class="input input__text p-4">
    </div>
    <div class="col-12 col-md-6 mb-3">
        <label for="fecha2">Hasta</label>
        <input type="month" id="fecha2" class="input input__text p-4">
    </div>
    <div class="mb-4 mt-1">
...
<script>
    ...
    function buscarVenta(){
        ...
        var ruta = "{{ url('reporte-meses-search/') }}/" + fecha1 + "/"+ fecha2 +"";
        $.ajax({
            url: ruta,
            type: "get",
            success: function(data) {
                let imprimir=document.getElementById("imprimir");
                imprimir.href=`reporte-pdf-meses/${data[0].fecha1}/and/${data[0].fecha2}`;
