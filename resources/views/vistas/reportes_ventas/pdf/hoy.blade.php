...
<body>
    ...
    <h2 class="title">SALIDAS DE HOY <?= date("d-m-Y") ?></h2>
    <div class="datosVenta">
        <table class="tabla4">
            ...
            <tr>
                ...
                <td colspan="2" style="font-weight: bold"><span>$</span>&nbsp;&nbsp;&nbsp;{{$items->tot}}</td>
            </tr>            
            <tr>
                <td colspan="2">Descuento : </td>
                <td colspan="2" style="font-weight: bold"><span>$</span>&nbsp;&nbsp;&nbsp;{{$items->desc}}</td>
            </tr>
            <tr style="background: #FF6458;">
                <td colspan="2">Total a pagar : </td>
                <td colspan="2" style="font-weight: bold;font-size: 13px"><span>$</span>&nbsp;&nbsp;&nbsp;{{$items->pagoTotal}}</td>
            </tr>
            @endforeach
        </table>
    </div>
