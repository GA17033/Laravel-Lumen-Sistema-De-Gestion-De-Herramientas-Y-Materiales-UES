@extends('layouts/app')
@section('titulo',"SALIDAS POR AÑO")
@section('content')
<h4 class="text-center text-secondary">SALIDAS POR AÑO</h4>
...
<script>
    ...
    function buscarVenta(){
        ...
        var ruta = "{{ url('reporte-anio-search/') }}/" + valor + "";
        $.ajax({
            url: ruta,
            type: "get",
            success: function(data) {
                let imprimir=document.getElementById("imprimir");
                imprimir.href=`reporte-pdf-anio-${data[0].fecha}`;
