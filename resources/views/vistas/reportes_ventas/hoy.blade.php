...
@section('content')
<h4 class="text-center text-secondary">SALIDAS DE HOY</h4>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="" class="text-dark font-weight-bold" style="font-size: 18px">
                        <span class="badge bg-primary">${{$i->total}}</span>
                    </td>
                    <td colspan="" class="text-dark font-weight-bold" style="font-size: 18px">
                        <span class="badge bg-primary">${{$i->desc}}</span>
                    </td>
                    <td colspan="" class="text-dark font-weight-bold" style="font-size: 18px">
                        <span class="badge bg-primary">${{$i->tot}}</span>
                    </td>
                </tr>
                @endforeach
            </tbody>
